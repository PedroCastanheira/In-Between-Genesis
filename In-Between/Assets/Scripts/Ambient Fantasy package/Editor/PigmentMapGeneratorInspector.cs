...
namespace FAE
{
    ...
    public class PigmentMapGeneratorInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            terrainInfo = string.Format("Terrain size: {0}x{1} \nTerrain origin: X: {2} Z: {3}", pmg.terrainScaleOffset.x, pmg.terrainScaleOffset.y, pmg.terrainScaleOffset.z - 1, pmg.terrainScaleOffset.w - 1);
            terrainInfo.Replace("\\n", "\n"); //Break lines

            if (showHelp) EditorGUILayout.HelpBox(terrainInfo, MessageType.Info);
        ...
        private void DoHeader()
        {
            ...
            if (showHelp) EditorGUILayout.HelpBox("If you'd like some objects to be included, like cliffs, parent them under your terrain object./n/nFor a multi-terrain setup, add this script to an object which isn't a terrain.", MessageType.Info);
